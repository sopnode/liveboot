...
#LIVEBOOT xconfig --startxonboot
zerombr
clearpart --all
part / --size 5120 --fstype ext4
#LIVEBOOT services --enabled=NetworkManager,ModemManager --disabled=sshd
services --enabled=NetworkManager --disabled=sshd
network --bootproto=dhcp --device=link --activate
#LIVEBOOT TMP until we get cloud-init
...
#LIVEBOOT
systemctl enable --now cloud-init 2> /dev/null || :
